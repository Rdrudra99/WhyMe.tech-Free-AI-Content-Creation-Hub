  ...
  try {
    const completion = await groq.chat.completions.create({
      messages: [
        {
          role: "system",
          content: `As an AI assistant specialized in code explanation, your task is to provide clear and detailed explanations of code snippets. Ensure that your explanations are easy to follow, concise, and provide sufficient context for the reader to understand the code's functionality and purpose. Use Markdown or a similar structured format for better readability and presentation.`,
      },
        {
          role: 'user',
          content: baseMessage
