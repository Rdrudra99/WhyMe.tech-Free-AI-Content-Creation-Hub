  ...
  return (
    <>
      ...
      >
        ...
        <kbd className="pointer-events-none absolute right-[0.3rem] top-[0.3rem] hidden h-5 select-none items-center gap-1 rounded-full border bg-muted px-1.5  text-[10px] font-medium opacity-100 sm:flex">
