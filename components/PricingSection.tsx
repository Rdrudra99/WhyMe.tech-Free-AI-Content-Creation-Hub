        ...
        <div className="container py-24 lg:py-32 overflow-hidden">
            ...
            <div className="container overflow-hidden mx-auto pb-10">
                ...
                <h2 className="text-sm md:text-base my-4 text-gray-500 font-normal dark:text-muted-dark text-center max-w-lg mx-auto">
                    Discover the perfect plan for your content needs with Whyme.tech. From free to premium, we have options for everyone.
                </h2>
            ...
            <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
                ...
                <Card>
                    ...
                    <CardDescription className="text-center w-11/12 mx-auto">
                        Collaboration tools for your growing business
                    </CardDescription>
                    <CardContent>
                        <ul className="mt-7 space-y-2.5 text-sm">
                            <li className="flex space-x-2">
                ...
                <Card>
                    <CardHeader className="text-center pb-2">
                        ...
                        <span className="font-bold text-5xl">₹129</span>
                    </CardHeader>
                    <CardDescription className="text-center w-11/12 mx-auto">
